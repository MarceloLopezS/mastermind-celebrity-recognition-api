        ...
        if (err) {
            ...
            const activateUser = async () => {
                ...
                try {
                    ...
                    if (selectAuthResponse.rows[0].expiration !== 'infinity' && stringDateToTimestamp(selectAuthResponse.rows[0].expiration) < Date.now() ) {
                    ...
                    const updateAuth = "UPDATE auth SET activation = $1, expiration = $2 WHERE email = $3";
